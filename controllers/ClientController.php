...
class ClientController
{
    public static function CrearCliente()
    {
        if (isset($_POST["nuevoCliente"])) {
            ...
            if (
                preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoCliente"]) && preg_match('/^[0-9]+$/', $_POST["nuevoDocumentoId"]) &&
    ...
    public static function MostrarClientes($item, $valor)
    {
        $tabla = "clientes";
    ...
    public static function EditarCliente()
    {
        if (isset($_POST["editarCliente"])) {
            ...
            if (
                preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarCliente"]) && preg_match('/^[0-9]+$/', $_POST["editarDocumentoId"]) &&
