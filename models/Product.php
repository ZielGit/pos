...
class Product
{
	public static function MostrarProductos($tabla, $item, $valor, $orden)
	{
		if ($item != null) {
	...
	public static function IngresarProducto($tabla, $datos)
	{
	...
	public static function EditarProducto($tabla, $datos)
	{
	...
	public static function EliminarProducto($tabla, $datos)
	{
	...
	public static function ActualizarProducto($tabla, $item1, $valor1, $valor)
	{
	...
	public static function MostrarSumaVentas($tabla)
	{
